...
trait UltiKafkaStreamsCommand[AggId, Agg, Cmd, Event, CmdMeta, Envelope]
...
private[scaladsl] class UltiKafkaStreamsCommandImpl[AggId, Agg, Command, Event, CmdMeta, Envelope](
