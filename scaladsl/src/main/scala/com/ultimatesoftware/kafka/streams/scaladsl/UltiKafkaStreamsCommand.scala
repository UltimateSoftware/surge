...
object UltiKafkaStreamsCommand {
  def apply[AggId, Agg, Cmd, Event, CmdMeta, Envelope <: com.ultimatesoftware.mp.serialization.envelope.Envelope](
...
private[scaladsl] class UltiKafkaStreamsCommandImpl[AggId, Agg, Command, Event, CmdMeta, Envelope <: com.ultimatesoftware.mp.serialization.envelope.Envelope](
