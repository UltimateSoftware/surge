...
/**
 * Calculate an exponentially weighted moving average of observed values. The given weight is the weighting given to current value when calculating a new
 * average from an observed value.
 * @param weight
 *   The weight (between 0.0 and 1.0) given to the current average when applying a new observed value
 */
