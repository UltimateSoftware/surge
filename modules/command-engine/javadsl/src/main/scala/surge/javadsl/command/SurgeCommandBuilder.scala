...
class Buildable[AggId, Agg, Command, Evt](businessLogic: SurgeCommandBusinessLogicTrait[AggId, Agg, Command, Evt, Agg]) {
...
class SurgeCommandBuilder {
  ...
  def withBusinessLogic[AggId, Agg, Command, Evt](
      businessLogic: SurgeCommandBusinessLogicTrait[AggId, Agg, Command, Evt, Agg]): Buildable[AggId, Agg, Command, Evt] = {
