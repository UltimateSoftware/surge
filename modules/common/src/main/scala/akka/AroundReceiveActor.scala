...
/**
 * Actor that can be used to extend the underlying behavior of aroundReceive in order to extend or transform messages before they're passed to an actor. Be
 * careful when using this as the power exposed leaves a lot of room to shoot yourself in the foot.
 */
