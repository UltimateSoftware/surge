 ...
 *
 * @param stopMessage
 *   The message sent back to the child to acknowledge the child's request to passivate. Once the child receives this, it may terminate. If it terminates before
 *   this, the parent actors supervision strategy may kick in and restart the actor.
 */
