...
/**
 * This extension wraps an actor system and exposes the underlying address for that actor system, which allows us to ask the actor system directly on what
 * host/port it is running rather than trying to pull this from configuration settings in different places.
 *
 * @param system
